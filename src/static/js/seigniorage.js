...
const main = async() => {
    ...
    let table = window.buildTable("self_stabilizing_table", tableData, false, "table table-striped table-hover caption-top")
    ...
    let table2 = window.buildTable("seigniorage_shares_table", table2Data, false, "table table-striped table-hover caption-top")
