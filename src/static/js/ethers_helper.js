...
const init_wallet = async function (callback) {
  ...
  let text = $("#connect_wallet_button").text()
  $("#connect_wallet_button").empty()
  $("#connect_wallet_button").append(window.styled_connect_wallet(text))

  $("#clear_browser_storage").empty()
  $("#clear_browser_storage").append(window.styled_clear_browser)
}
